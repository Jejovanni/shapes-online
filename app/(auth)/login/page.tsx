    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            if (email === 'user@example.com' && password === 'password') {
                ...
                alert('Login failed: Invalid email or password. (Mock)');
            }
        }, 1500);
        // --- End Placeholder ---
    };
    ...
    return (
        <div className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="text-sm">
                        <a href="/forgot-password" className="font-medium text-pink-600 hover:text-pink-500 transition">
                            Forgot your password? (Mock)
                        </a>
                    </div>
                </div>
            ...
            <div className="text-center text-sm text-gray-600">
                New to Shapes Shop?{' '}
                <a href="/register" className="font-medium text-pink-600 hover:text-pink-500 transition">
                    Create an account
                </a>
            </div>
        </div>
